...
TELEGRAM_BOT_TOKEN = "8366557873:AAGyZsCn21_sgHf_EzQ87Z4Ex0_KBwFoGIE" # Change with your telegram bot token
TELEGRAM_CHAT_ID = "7947503294" # Change with your telegram chat id
...
"""
    ...
    logger.info(f"👤 Created by: @root991")
    logger.info(f"📢 Channel: @premiumlootersonly")
    ...
    send_telegram_message(
        ...
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"👤 Created by: @root991\n"
        f"� Join: @premiumlootersonly"
    )
...
""")
    ...
    logger.info("👤 Created by: @root991")
    logger.info("📢 Channel: @premiumlootersonly")
